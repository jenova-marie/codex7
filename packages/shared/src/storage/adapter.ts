...
export interface StorageAdapter {
   ...
   * List all libraries
   */
  listLibraries(options?: { limit?: number; offset?: number }): Promise<Result<Library[], Error>>;
   ...
   * List indexing jobs
   */
  listIndexingJobs(options?: { limit?: number; offset?: number }): Promise<Result<IndexingJob[], Error>>;
}
