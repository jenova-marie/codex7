 ...
 * ```
 */
export function parseLibraryId(id) {
 ...
 * ```
 */
export function formatLibraryId(components) {
 ...
 * ```
 */
export function extractLibraryIdFromGitHub(url) {
...
//# sourceMappingURL=library-id.js.map